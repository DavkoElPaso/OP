...
class GameLogic:
    ...
    def load_level(self, level):
        ...
        if level == 1:
            ...
            self.obstacles = [Obs (560, 440),Obs(760, 350), Obs(1150, 200), Obs(1370, 200), Obs(1590, 200), Obs(1810, 200),
                              Obs(2200, 290)]
            self.pivo = Pivo(2270, 250)
            self.coin = Coin(2050, 50)
        elif level == 2:
            self.enemies = [Enemy(570, 261), Enemy(950, 141), Enemy(1750, 41), Enemy(2250, 41)]
            self.obstacles = [Obs(330, 440), Obs(550, 360), Obs(950, 240), Obs(1250, 140), Obs(1750, 140), Obs(2250, 140),
                              Obs(2750, 140)]
            self.pivo = Pivo(2800, 100)
            self.coin = Coin(1700, 400)
        elif level == 3:
            self.enemies = [Enemy(920, 241), Enemy(1420, 150), Enemy(1920, 100), Enemy(2420, 50), Enemy(2920, 50),
                            Enemy(3420, 50)]
            self.obstacles = [Obs(940, 340), Obs(1400, 250), Obs(1900, 200), Obs(2400, 150),
